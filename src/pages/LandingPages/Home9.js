    ...
    return (
        <div className='bg-white'>
            <div className="max-w-6xl mx-auto w-full font-display flex flex-col justify-center px-5 py-10">
                <section className='max-w-[62rem] w-full mx-auto flex flex-col md:flex-row gap-x-10 items-center py-5 px-10 rounded-xl'>
                    <img src={ads} alt=""/>
                    <div id='komunitas' className='flex flex-col gap-y-3 mt-4 md:mt-0'>
